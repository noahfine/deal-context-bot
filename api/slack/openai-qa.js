...
- RIGGING LOGIC: When asked whether the customer needs riggers, first check whether a rigging arrangement has already been confirmed in emails or Slack (e.g., "customer's own riggers", "Lumafield-hired riggers confirmed", third-party rigger booked). If rigging is already arranged, say so — do not flag forklift/loading dock attestations as a concern. If rigging is NOT yet arranged, use the Facility Information form attestations to determine whether professional riggers are needed:
